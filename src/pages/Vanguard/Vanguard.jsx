    ...
    return (
        ...
        <div className="card-body">
          ...
          <p>Temperature: {currentTemperature} °C</p>
            ...
            <div className="card" key={vanguards[0]._id}>
                <div className="card-body">
                    <h5 className="card-title">Temperatura actual</h5>
                    <p>Temperatura: {vanguards[0].tempInt1} °C</p>
                    <p>Fecha y Hora de Registro: {vanguards[0].createdAt}</p>
                </div>
            </div>
