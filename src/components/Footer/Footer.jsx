  ...
  return (
    ...
    <div className='footer-container'>
      <div className='row'>
        ...
        <div className='col-lg-3 col-sm-6'>
          <div className="single-box">
            <h2>Web & mobile check-in quick guide</h2>
            <ul>
              <li><a href="#">How do I check in for my trip?</a></li>
              <li><a href="#">Web check-in steps</a></li>
              <li><a href="#">Mobile check-in steps</a></li>
        ...
        <div className='col-lg-3 col-sm-6'>
          <div className="single-box">
            <h2>About MyTinerary</h2>
            <p>MyTinerary knows how to take you to that experience you crave when you visit unknown territory.
            ...
            <a className="aNetz" href=""><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
